...
public class ClientWebSocket {
     ...
     */
    private static ConcurrentMap<Long, ClientWebSocket> webSocketMap = new ConcurrentHashMap<>();
    private final Logger logger = LoggerFactory.getLogger(ClientWebSocket.class);
    /**
     * websocket的session
     */
    ...
    public static boolean sendMessageToUser(String message, Long userId) {
        ClientWebSocket tWebSocket = webSocketMap.get(userId);
